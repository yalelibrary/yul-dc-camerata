...
RSpec.describe Camerata::TaggableApp, type: :github_api do
  ...
  context "#release_notes" do
    ...
    it "generates release notes" do
      VCR.use_cassette("solr_release_notes_without_feature", allow_playback_repeats: true) do
  ...
  context "#last_version_number" do
    ...
    it "gets the last_version_number" do
      VCR.use_cassette("blacklight_last_version_number") do
        expect(taggable_app.last_version_number).to eq "v1.18.0"
      end
    end
  end
